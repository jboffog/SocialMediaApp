                ...
                builder: (context, snapshot) {
                  if (snapshot.hasError) {
                    ...
                    return snapshot.connectionState == ConnectionState.waiting
                        ...
                        : StoryPageView(
                            indicatorPadding: EdgeInsets.symmetric(vertical: 50.0, horizontal: 10.0),
                            ...
                            itemBuilder: (context, pageIndex, storyIndex) {
                              StatusModel stats = StatusModel.fromJson(status.toList()[storyIndex].data());
                              ...
                              return Container(
                                  ...
                                  child: Stack(children: [
                                    Padding(padding: EdgeInsets.symmetric(vertical: 50.0), child: getImage(stats.url!)),
                                    Positioned(
                                        top: 65.0,
                                        left: 10.0,
                                        child: FutureBuilder(
                                                ...
                                                return Padding(
                                                    ...
                                                    child: Row(children: [
                                                      ...
                                                      Column(children: [
                                                        ...
                                                        Text("${timeago.format(stats.time!.toDate())}",
                                                            style: TextStyle(
                                                                fontSize: 12.0,
                                            ...
                                            children: [
                                                  ...
                                                  child: Center(
                                                      child: Column(
                                                        ...
                                                        Padding(
                                                            ...
                                                            child: Text(stats.caption!, textAlign: TextAlign.center))
                                                      ]))),
                                              if (widget.userId == firebaseAuth.currentUser!.uid)
                                                TextButton.icon(
                                                    ...
                                                    label: Text(stats.viewers!.length.toString(),
                                                        style: TextStyle(
