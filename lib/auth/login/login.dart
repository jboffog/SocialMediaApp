  ...
  Widget build(BuildContext context) {
    ...
    return LoadingOverlay(
        ...
        child: Scaffold(
            ...
            body: ListView(padding: EdgeInsets.symmetric(horizontal: 15.0, vertical: 20.0), children: [
              ...
              Center(child: Text('Welcome back!', style: TextStyle(fontSize: 23.0, fontWeight: FontWeight.w900))),
              Center(
                  child: Text('Log into your account and get started!',
                      style: TextStyle(
                          fontSize: 12.0,
